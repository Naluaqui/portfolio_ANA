          ...
          <div className="hidden md:flex items-center space-x-1">
            {navLinks.map((link) => (
              <NavLink
                ...
                className={({ isActive }) =>
                  `relative px-6 py-2 text-sm font-semibold tracking-wider transition-all duration-300 group ${
                    isActive ? "text-cyan-400" : "text-gray-400 hover:text-pink-400"
                  }`
                }
              >
                {({ isActive }) => (
            ...
            <div className="px-4 py-4 space-y-2">
              {navLinks.map((link) => (
                <NavLink
                  ...
                  className={({ isActive }) =>
                    `block px-4 py-3 rounded-lg text-sm font-semibold tracking-wider transition-all duration-300 ${
                      isActive
